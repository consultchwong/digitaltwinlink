...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold hidden sm:block">DigitalTwinLink</span>
          </div>
      ...
      {/* Hero Section */}
      <div className="pt-20">
        <HeroSection onGetStarted={handleGetStarted} onSignIn={() => setIsAuthModalOpen(true)} />
      </div>
      ...
      <footer className="py-12 px-4 border-t border-border bg-surface">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-bold">DigitalTwinLink</span>
              </div>
              <p className="text-sm text-muted-foreground">
                AI-powered character conversations for mission-focused interactions.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              © 2026 DigitalTwinLink. All rights reserved.
            </p>
